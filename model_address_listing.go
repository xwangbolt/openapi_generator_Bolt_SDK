...
// checks if the AddressListing type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressListing{}
...
func (o AddressListing) MarshalJSON() ([]byte, error) {
...
type NullableAddressListing struct {
	value *AddressListing
	isSet bool
}

func (v NullableAddressListing) Get() *AddressListing {
	return v.value
}

func (v *NullableAddressListing) Set(val *AddressListing) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressListing) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressListing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressListing(val *AddressListing) *NullableAddressListing {
	return &NullableAddressListing{value: val, isSet: true}
}

func (v NullableAddressListing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressListing) UnmarshalJSON(src []byte) error {
	v.isSet = true
